                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            Flexible(
                              child: Text(
                                ...
                                style: robotoMedium.copyWith(fontSize: 13//Dimensions.fontSizeSmall,
                                ),
                          ...
                          isStore && (store != null && store!.ratingCount! > 0) ? Row(children: [
                            ...
                            Text(
                              ...
                              style: robotoMedium.copyWith(
                                  fontSize: 15,
                                fontWeight: FontWeight.bold,//Dimensions.fontSizeSmall
                                color: const Color(0xff19555d)
                            ...
                            discount > 0 ? Text(
                              ...
                              style: robotoMedium.copyWith(
                                fontSize: 13,//Dimensions.fontSizeExtraSmall,
                                color: Theme.of(context).disabledColor,
