                    ...
                    child: Column(
                      ...
                      Text(
                        ...
                        style: robotoRegular.copyWith(
                            ...
                            fontSize: 14//Dimensions.fontSizeSmall
                        ),
                      ),

                      Text(item!.name!, maxLines: 1, overflow:
                      TextOverflow.ellipsis, style: const TextStyle(
                        fontSize: 16,
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center, alignment: WrapAlignment.start, children: [
                        ...
                        Text(
                          ...
                          style: robotoRegular.copyWith(
                            fontSize: 14,//Dimensions.fontSizeExtraSmall,
                            color: Color(0xff19555d),//Theme.of(context).disabledColor,
