        ...
        itemBuilder: (context, index) {
          return Container(
            decoration: BoxDecoration(
              ...
              color: const Color(0xD0FFFFFF),//Theme.of(context).cardColor,
              image: DecorationImage(
                image: NetworkImage('${splashController.moduleList![index].iconFullUrl}'),
                fit: BoxFit.fill,
              ),// network image
              border: Border.all(
                  color: Colors.white
                //Theme.of(context).primaryColor, width: 0.15
              ),
