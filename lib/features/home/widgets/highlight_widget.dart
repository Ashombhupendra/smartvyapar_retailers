            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color(0xff014ff9),//Colors.green
                ),
              ),
            ),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('highlights_for_you'.tr, style: robotoBold.copyWith(
                          fontSize: Dimensions.fontSizeLarge, color: Colors.white)),
                      const SizedBox(width: 5),

                      Text('see_our_most_popular_store_and_item'.tr, style:
                      robotoRegular.copyWith(
                          color: Colors.white,//Theme.of(context).disabledColor,
