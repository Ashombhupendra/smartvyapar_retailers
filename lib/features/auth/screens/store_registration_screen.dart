...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen> with TickerProviderStateMixin {
  ...
  final FocusNode _adshaarFocus = FocusNode();
  final FocusNode _gstnumberFocus = FocusNode();
  final FocusNode _pancardFocus = FocusNode();
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              CustomTextField(
                                ...
                                controller: storeRegController.gstNumberController,
                                focusNode: _gstnumberFocus,
                                nextFocus: _adshaarFocus,
                                inputType: TextInputType.name,
                                prefixImage: Images.shopIcon,
                                capitalization: TextCapitalization.words,
                                required: true,
                              ...
                              CustomTextField(
                                hintText: 'Aadhaar Number'.tr,
                                controller: storeRegController.aadhaarController,
                                focusNode: _adshaarFocus,
                                nextFocus: _pancardFocus,
                                inputType: TextInputType.name,
                                capitalization: TextCapitalization.words,
                                ...
                                validator: (value) => ValidateCheck.validateEmptyText(value, "aadhaar number field is required".tr),
                              ),
                              const SizedBox(height: Dimensions.paddingSizeExtremeLarge),

                              CustomTextField(
                                hintText: 'Pan Card'.tr,
                                controller: storeRegController.panCardrController,
                                focusNode: _pancardFocus,
                                ...
                                iconSize: 25,
                                required: true,
                                labelText: 'Pan Card'.tr,
                                validator: (value) => ValidateCheck.validateEmptyText(value, "Pan Card field is required".tr),
                              ),
                              const SizedBox(height: Dimensions.paddingSizeExtremeLarge),
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Align(alignment: Alignment.center, child: Stack(children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: InkWell(
                                          onTap: () => storeRegController.pickImage(ImageType.logo, false),
                                          child: DottedBorder(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Stack(children: [
                                      ...
                                      Positioned(
                                        bottom: 0, right: 0, top: 0, left: 0,
                                        child: InkWell(
                                          onTap: () => storeRegController.pickImage(ImageType.cover, false),
                                          child: DottedBorder(
                                            color: Theme.of(context).primaryColor,
                                            strokeWidth: 1,
                                            strokeCap: StrokeCap.butt,
                                ...
                                children: [
                                  Align(alignment: Alignment.center, child: Stack(children: [
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                        child: storeRegController.pickedGst != null ? GetPlatform.isWeb ? Image.network(
                                          storeRegController.pickedGst!.path, width: 150, height: 120, fit: BoxFit.cover,
                                        ) : Image.file(
                                          File(storeRegController.pickedGst!.path), width: 150, height: 120, fit: BoxFit.cover,
                                        ) : SizedBox(
                                          width: 150, height: 120,
                                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    Positioned(
                                      bottom: 0, right: 0, top: 0, left: 0,
                                      child: InkWell(
                                        onTap: () => storeRegController.pickImage(ImageType.gst, false),
                                        child: DottedBorder(
                                          color: Theme.of(context).primaryColor,
                                          strokeWidth: 1,
                                          strokeCap: StrokeCap.butt,
                                          ...
                                          child: Center(
                                            child: Visibility(
                                              visible: storeRegController.pickedGst != null,
                                              child: Container(
                                                padding: const EdgeInsets.all(25),
                                                decoration: BoxDecoration(
                                                  border: Border.all(width: 2, color: Colors.white),
                                  ...
                                  Align(alignment: Alignment.center, child: Stack(children: [
                                    ...
                                    Positioned(
                                      bottom: 0, right: 0, top: 0, left: 0,
                                      child: InkWell(
                                        onTap: () => storeRegController.pickImage(ImageType.fssai, false),
                                        child: DottedBorder(
                                          color: Theme.of(context).primaryColor,
                                          strokeWidth: 1,
                                          strokeCap: StrokeCap.butt,
                                ...
                                children: [
                                  Align(alignment: Alignment.center, child: Stack(children: [
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                        child: storeRegController.pickedAadhar != null ? GetPlatform.isWeb ? Image.network(
                                          storeRegController.pickedAadhar!.path, width: 150, height: 120, fit: BoxFit.cover,
                                        ) : Image.file(
                                          File(storeRegController.pickedAadhar!.path), width: 150, height: 120, fit: BoxFit.cover,
                                        ) : SizedBox(
                                          width: 150, height: 120,
                                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    Positioned(
                                      bottom: 0, right: 0, top: 0, left: 0,
                                      child: InkWell(
                                        onTap: () => storeRegController.pickImage(ImageType.aadhar, false),
                                        child: DottedBorder(
                                          color: Theme.of(context).primaryColor,
                                          strokeWidth: 1,
                                          strokeCap: StrokeCap.butt,
                                          ...
                                          child: Center(
                                            child: Visibility(
                                              visible: storeRegController.pickedAadhar != null,
                                              child: Container(
                                                padding: const EdgeInsets.all(25),
                                                decoration: BoxDecoration(
                                                  border: Border.all(width: 2, color: Colors.white),
                                  ...
                                  Align(alignment: Alignment.center, child: Stack(children: [
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                        child: storeRegController.pickedPancard != null ? GetPlatform.isWeb ? Image.network(
                                          storeRegController.pickedPancard!.path, width: 150, height: 120, fit: BoxFit.cover,
                                        ) : Image.file(
                                          File(storeRegController.pickedPancard!.path), width: 150, height: 120, fit: BoxFit.cover,
                                        ) : SizedBox(
                                          width: 150, height: 120,
                                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    Positioned(
                                      bottom: 0, right: 0, top: 0, left: 0,
                                      child: InkWell(
                                        onTap: () => storeRegController.pickImage(ImageType.pancard, false),
                                        child: DottedBorder(
                                          color: Theme.of(context).primaryColor,
                                          strokeWidth: 1,
                                          strokeCap: StrokeCap.butt,
                                          ...
                                          child: Center(
                                            child: Visibility(
                                              visible: storeRegController.pickedPancard != null,
                                              child: Container(
                                                padding: const EdgeInsets.all(25),
                                                decoration: BoxDecoration(
                                                  border: Border.all(width: 2, color: Colors.white),
                              ...
                              Align(alignment: Alignment.center, child: Stack(children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                    child: storeRegController.pickedMsme != null ? GetPlatform.isWeb ? Image.network(
                                      storeRegController.pickedMsme!.path, width: 150, height: 120, fit: BoxFit.cover,
                                    ) : Image.file(
                                      File(storeRegController.pickedMsme!.path), width: 150, height: 120, fit: BoxFit.cover,
                                    ) : SizedBox(
                                      width: 150, height: 120,
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                Positioned(
                                  bottom: 0, right: 0, top: 0, left: 0,
                                  child: InkWell(
                                    onTap: () => storeRegController.pickImage(ImageType.msme, false),
                                    child: DottedBorder(
                                      color: Theme.of(context).primaryColor,
                                      strokeWidth: 1,
                                      strokeCap: StrokeCap.butt,
                                      ...
                                      child: Center(
                                        child: Visibility(
                                          visible: storeRegController.pickedMsme != null,
                                          child: Container(
                                            padding: const EdgeInsets.all(25),
                                            decoration: BoxDecoration(
                                              border: Border.all(width: 2, color: Colors.white),
